...
public class Customer {
	...
	public static Customer createCustomer(String cusType, String name, String address, String iD, String phone, int reward_points) {
		if (cusType.equals("Guest"))
			return new GuestCustomer(name, address, iD, phone);
		else if (cusType.equals("Vip"))
			return new VIPCustomer(name, address, iD, phone);
		else if (cusType.equals("SuperVip"))
			return SupVipCustomer.getInstance(name, address, iD, phone);
		else
			return null;
	}
}
